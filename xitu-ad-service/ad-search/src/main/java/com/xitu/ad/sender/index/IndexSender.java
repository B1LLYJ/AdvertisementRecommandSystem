package com.xitu.ad.sender.index;

import com.alibaba.fastjson.JSON;
import com.xitu.ad.dump.table.*;
import com.xitu.ad.handler.AdLevelDataHandler;
import com.xitu.ad.index.DataLevel;
import com.xitu.ad.mysql.constant.Constant;
import com.xitu.ad.mysql.dto.MySqlRowData;
import com.xitu.ad.sender.ISender;
import com.xitu.ad.utils.CommonUtils;
...
public class IndexSender implements ISender {
    ...
    private void Level4RowData(MySqlRowData rowData) {
        ...
        switch (rowData.getTableName()) {
            ...
            case Constant.AD_UNIT_DISTRICT_TABLE_INFO.TABLE_NAME: List<AdUnitDistrictTable> districtTables = new ArrayList<>();
            ...
            case Constant.AD_UNIT_IT_TABLE_INFO.TABLE_NAME: List<AdUnitItTable> itTables = new ArrayList<>();
